...
window.lbTapUser = function(uid, username, avatar) {
  ...
  var statusHtml = window.onlineUserIds?.has(uid) ? '<p class="text-xs text-blue-400 flex items-center gap-1"><span class="w-2 h-2 bg-blue-500 rounded-full inline-block"></span> Online now</p>' : '<p class="text-xs text-mist">Offline</p>';
  sheet.innerHTML = `
